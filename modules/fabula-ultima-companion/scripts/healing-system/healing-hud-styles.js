...
.oni-heal-cell .pc-token {
  width: 92px; height: 92px; object-fit: contain; flex: 0 0 auto;
  filter: drop-shadow(0 3px 5px rgba(60,40,20,.45));
}
.oni-heal-cell .pc-info { display: flex; flex-direction: column; gap: 5px; min-width: 0; flex: 1; }
.oni-heal-cell .pc-name { font-size: 19px; font-weight: 800; color: var(--hl-ink); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
...
.oni-heal-res .rval { font-size: 16px; font-weight: 700; color: var(--hl-ink); }
