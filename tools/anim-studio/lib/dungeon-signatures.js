...
function railStream(opts = {}) {
  const cfg = Object.assign({
    ...
    rainWebmThickness: 0.11, rainBoltLifeMs: 900,
  ...
  const body = [
    ...
    "      // LENGTH and thickness is set independently. Left as a plain sprite",
    "      // width, a 1600x400 ray becomes hundreds of pixels THICK and the bolts",
    "      // merge into a single wall of light.",
    "      r.sprite.anchor.set(0, 0.5);",
    "      r.sprite.width = fall;",
    "      r.sprite.height = fall * cfg.rainWebmThickness;",
